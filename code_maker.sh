...
cd      $TARGET/$PROJECT;
bash    $ROOT/scripts/$STARTER $STARTER $TARGET/$PROJECT $VOGSPHERE $GITHUB
bash    $TARGET/$PROJECT/$STARTER
...
bash    $ROOT/commands/pre-commit.sh pre-commit $TARGET/$PROJECT